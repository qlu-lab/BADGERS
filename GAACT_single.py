...
def run(args):
    ...
    g = G03_betas.run(args)
    G04_zscores.run(args, g)

if __name__ == "__main__":
    import argparse
    parser = argparse.ArgumentParser(description='GAACT.py %s:  Will estimate GAACT results from a set of snp covariance matrices, a model database, and GWAS beta files.' % (__version__))
