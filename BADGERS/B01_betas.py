...
from badgers import Constants
from badgers.gwas import GWAS
from badgers.gwas import Utilities as GWASUtilities
from badgers import PredictionModel
...
if __name__ == "__main__":
    import argparse
    parser = argparse.ArgumentParser(description='B03_betas.py %s: Build betas from GWAS data as expected by MetaXcan.' % (__version__))
